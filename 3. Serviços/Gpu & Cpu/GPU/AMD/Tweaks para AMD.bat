...
echo [HDCP] Desativando protecao de conteudo HDCP
...
echo [OK] HDCP aplicado
echo.

echo [HZ] Desativando override de taxa de atualizacao
...
echo [OK] Override de refresh desligado
echo.

echo [SHOT] Desativando snapshot
...
echo [OK] Snapshot desligado
echo.

echo [AA] Desativando anti aliasing no driver
...
echo [OK] Anti aliasing ajustado
echo.

echo [SUB] Desativando subscriptions do driver
...
echo [OK] Subscriptions desligado
echo.

echo [ANISO] Desativando anisotropic filtering no driver
...
echo [OK] Aniso ajustado
echo.

echo [OVR] Desativando overlay da radeon
...
echo [OK] Overlay desligado
echo.

echo [VID] Ativando adaptive de interlacing
...
echo [OK] De interlacing ligado
echo.

echo [SKIN] Desativando skins do driver
...
echo [OK] Skins desligado
echo.

echo [COLOR] Desativando reducao automatica de cor
...
echo [OK] Reducao automatica desligada
echo.
...
echo [OK] De lag ligado
echo.

echo [FRT] Desativando frame rate target
...
echo [OK] FRT desligado
echo.

echo [DMA] Desativando dma copy
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "DisabledMACopy" /t REG_DWORD /d "1" /f 

echo [OK] DMA copy desligado
echo.
...
echo [STUT] Desativando stutter mode
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "StutterMode" /t REG_DWORD /d "0" /f 

echo [OK] Stutter mode desligado
echo.

echo [PRE] Desativando preemption da gpu
...
echo [OK] Preemption ajustado
echo.

echo [3D] Setando main3d
...
echo [OK] Main3d setado
echo.

echo [FQS] Setando flip queue size
...
echo [OK] Flip queue size setado
echo.

echo [CACHE] Setando tamanho do shader cache
...
echo [OK] Shader cache setado
echo.

echo [TFQ] Configurando tfq
